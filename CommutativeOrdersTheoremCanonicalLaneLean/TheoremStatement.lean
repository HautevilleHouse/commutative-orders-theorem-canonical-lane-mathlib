import CommutativeOrdersTheoremCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String := "commutative-orders-theorem-canonical-lane"
def sourceDescription : String := "Commutative Orders Theorem"

structure SourceTheoremBoundary where
  claimBoundary : String

def sourceTheoremBoundary : SourceTheoremBoundary := {
  claimBoundary := "classical source boundary of Commutative Orders Theorem"
}
